...
MY_MODULES = project-module.o pca9685.o mcp3008.o protocol.o uart_extras.o  

# Targets for this makefile
AIR = build/air.bin
GROUND = build/ground.bin
...
CFLAGS += -I./include -Og -g -std=c99 $$warn $$freestanding #student added header files inside include
...
# Build and run the air-side application binary
air: $(AIR)
	rpi-run.py -p $<
